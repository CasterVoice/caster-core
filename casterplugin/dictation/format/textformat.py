...
class TextFormat():
    ...
    7 cop - Whatever speech engine provides,
            initial letter capitalized
    8 slip - whatever speech engine provides,
    ...
    def get_text_format_description(cls, capitalization, spacing):
        caps = {0: "<none>", 1: "yell", 2: "tie", 3: "gerrish", 4: "sing",
                5: "laws", 6: "say", 7: "cop", 8: "slip"}
        spaces = {
            0: "<none>",
            1: "gum",
            2: "spine",
        ...
        text = cls.formatted_text(capitalization, spacing,
                                  str("this is a test"))
...
primary_format = TextFormat(5, 0)
secondary_format = TextFormat(1, 0)


def _choose_format(big):
    return primary_format if not big else secondary_format
...
def master_format_text(capitalization, spacing, textnv):
    capitalization, spacing = TextFormat \
        .normalize_text_format(capitalization, spacing)
    Text(TextFormat.formatted_text(capitalization, spacing, str(textnv))) \
        .execute()
